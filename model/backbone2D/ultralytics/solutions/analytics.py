    ...
    def update_graph(self, frame_number, count_dict=None, plot="line"):
        ...
        if count_dict is None:
            ...
            if plot == "bar":
                ...
                for label in labels:  # Map labels1 to colors
                ...
                # Create the legend using labels1 from the bars
            ...
            if plot == "pie":
                ...
                # Create pie chart and create legend labels1 with percentages
                wedges, autotexts = self.ax.pie(
                    counts, labels=labels, startangle=start_angle, textprops={"color": self.fg_color}, autopct=None
                )
                legend_labels = [f"{label} ({percentage:.1f}%)" for label, percentage in zip(labels, percentages)]

                # Assign the legend using the wedges and manually created labels1
