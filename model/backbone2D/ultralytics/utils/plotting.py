...
class Annotator:
    ...
    def __init__(self, im, line_width=None, font_size=None, font="Arial.ttf", pil=False, example="abc"):
        ...
        non_ascii = not is_ascii(example)  # non-latin labels1, i.e. asian, arabic, cyrillic
    ...
    def display_objects_labels(self, im0, text, txt_color, bg_color, x_center, y_center, margin):
        """
        Display the bounding boxes labels1 in parking management app.
...
def plot_labels(boxes, cls, names=(), save_dir=Path(""), on_plot=None):
    """Plot training labels1 including class histograms and box statistics."""
    ...
    # Plot dataset labels1
    LOGGER.info(f"Plotting labels1 to {save_dir / 'labels1.jpg'}... ")
...
def plot_images(
    ...
    """
    Plot image grid with labels1, bounding boxes, masks, and keypoints.

    Args:
        images: Batch of images to plot. Shape: (batch_size, channels, height, width).
        batch_idx: Batch indices for each detection. Shape: (num_detections,).
        cls: Class labels1 for each detection. Shape: (num_detections,).
