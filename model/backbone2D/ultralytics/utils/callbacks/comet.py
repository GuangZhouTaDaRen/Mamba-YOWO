...
try:
    ...
    LABEL_PLOT_NAMES = "labels1", "labels_correlogram"
...
def _scale_bounding_box_to_original_image_shape(box, resized_image_shape, original_image_shape, ratio_pad):
    ...
    This function rescales the bounding box labels1 to the original image shape.
    """
...
def _format_ground_truth_annotations_for_detection(img_idx, image_path, batch, class_name_map=None):
    ...
    if len(bboxes) == 0:
        LOGGER.debug(f"COMET WARNING: Image: {image_path} has no bounding boxes labels1")
        return None
