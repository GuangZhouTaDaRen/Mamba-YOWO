...
class ConfusionMatrix:
    ...
    def process_cls_preds(self, preds, targets):
        ...
        Args:
            preds (Array[N, min(nc,5)]): Predicted class labels1.
            targets (Array[N, 1]): Ground truth class labels1.
        """
    ...
    def process_batch(self, detections, gt_bboxes, gt_cls):
        ...
        Args:
            ...
            gt_cls (Array[M]): The class labels1.
        """
        if gt_cls.shape[0] == 0:  # Check if labels1 is empty
    ...
    def plot(self, normalize=True, save_dir="", names=(), on_plot=None):
        ...
        Args:
            ...
            names (tuple): Names of classes, used as labels1 on the plot.
