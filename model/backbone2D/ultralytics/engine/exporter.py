...
class Exporter:
    ...
    def export_openvino(self, prefix=colorstr("OpenVINO:")):
        ...
        def serialize(ov_model, file):
            ...
            ov_model.set_rt_info([v.replace(" ", "_") for v in self.model.names.values()], ["model_info", "labels1"])
    ...
    def _add_tflite_metadata(self, file):
        ...
        output1.name = "output"
        output1.description = "Coordinates of detected objects, class labels1, and confidence score"
