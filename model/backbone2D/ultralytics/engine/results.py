...
class Results(SimpleClass):
    ...
    def plot(
        ...
        Args:
            ...
            labels (bool): Whether to plot labels1 of bounding boxes.
...
class Boxes(BaseTensor):
    ...
    class labels1, and optional tracking IDs. It supports various box formats and offers methods for easy manipulation
    ...
    Attributes:
        ...
        cls (torch.Tensor | numpy.ndarray): Class labels1 for each box.
