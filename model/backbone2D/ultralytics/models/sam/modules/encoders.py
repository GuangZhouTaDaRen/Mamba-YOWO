...
class PromptEncoder(nn.Module):
    ...
    def forward(
        ...
        Args:
            points (Tuple[torch.Tensor, torch.Tensor] | None): Point coordinates and labels1 to embed. The first
                tensor contains coordinates with shape (B, N, 2), and the second tensor contains labels1 with
                shape (B, N).
