...
def get_cdn_group(
    ...
    and negative samples from the ground truths (gt). It applies noise to the class labels1 and bounding box coordinates,
    and returns the modified labels1, bounding boxes, attention mask and meta information.
    ...
    Args:
        ...
        class_embed (torch.Tensor): Embedding weights to map class labels1 to embedding space.
        num_dn (int, optional): Number of denoising. Defaults to 100.
        cls_noise_ratio (float, optional): Noise ratio for class labels1. Defaults to 0.5.
