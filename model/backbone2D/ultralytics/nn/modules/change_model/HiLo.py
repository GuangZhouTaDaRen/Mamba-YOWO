...
# HiLo Attention Block as per the paper "Fast Vision Transformers with HiLo Attention"
class HiLo(nn.Module):
    ...
    def forward(self, x, H, W):
        ...
        # Reshape the input to (B, H, W, C) with given H and W
        x = x.reshape(B, H, W, C)
...
if __name__ == '__main__':
    ...
    # Here, H and W should be provided as the spatial dimensions of the input
    output = block(input, 16, 8)  # H = 16, W = 8
    print(input.size())
    print(output.size())
